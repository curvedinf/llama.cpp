...
struct llm_build_delta_net_base : public llm_graph_context {
    ...
    //   then run the conv; steady-state decode uses the indexed in-place form instead
    // qkv_mixed: (qkv_dim, n_seq_tokens, n_seqs); returns the conv output: (channels, n_seq_tokens, n_seqs)
